jQuery(document).ready(function($) {
    ...
    $(document.body).on('click', '#update-http-status-archive' , function(){
        ...
        const data = {
            "action": "update_http_status_archive",
            "security": daim_nonce
        };
        ...
        $.post(daim_ajax_url, data, function(data) {
            ...
            window.location.replace(daim_admin_url + 'admin.php?page=daim-http-status');
