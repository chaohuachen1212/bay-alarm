<?php
        ...
        <div class="wrap">
            ...
            <h2><?php esc_html_e('Interlinks Manager - Dashboard', 'daim'); ?></h2>
            ...
            <div id="daext-menu-wrapper" class="daext-clearfix">
                ...
                <div class="interlinks-container">
                    ...
                    ( trim($data['op']) != 'all' and ( intval($data['op'], 10) == 0 or intval($data['op'], 10) == 1 ) )
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                if(get_post_status($result['post_id']) === false){
                                                    ...
                                                    echo '<a href="' . get_permalink($result['post_id']) . '">' . esc_html(apply_filters('the_title', $result['post_title'], $result['post_id'])) . '</a>';
                                                }
                                                ?>
                                            </td>
                    ...
                    <?php else : ?>        
                        ...
                        if(strlen(trim($filter)) > 0){
	                        ...
	                        echo '<div class="error settings-error notice is-dismissible below-h2"><p>' . esc_html__('There are no data at moment, click on the "Generate Data" button to generate data and statistics about the internal links of your blog.',
			                        'daim') . '</p></div>';
                        }
                ...
                <div class="sidebar-container">
                    ...
                    <div class="daext-widget">
                        ...
                        <div class="daext-widget-content">
                            ...
                            <p><?php esc_html_e('This procedure allows you to generate data and statistics about the internal links of your blog.', 'daim'); ?></p>
                    ...
                    <div class="daext-widget" id="filter-and-sort">
                        ...
                        <form method="GET" action="admin.php">
                            ...
                            <div class="daext-widget-content">
                                ...
                                <h3><?php esc_html_e('Optimization', 'daim'); ?></h3>
                                <p>
                                    <select name="op" id="op">
                                        <option value="all" <?php selected( $data['op'], 'all' ); ?>><?php esc_html_e('All', 'daim'); ?></option>
                                        <option value="0" <?php selected( $data['op'], '0' ); ?>><?php esc_html_e('Not Optimized', 'daim'); ?></option>
                                        <option value="1" <?php selected( $data['op'], '1' ); ?>><?php esc_html_e('Optimized', 'daim'); ?></option>
                                    </select>
                                </p>
                                ...
                                <p>
                                    <select name="sb" id="sb">
                                        <option value="pd"><?php esc_html_e('Date', 'daim'); ?></option>
                                        <option value="ti" <?php selected( $data['sb'], 'ti' ); ?>><?php esc_html_e('Title', 'daim'); ?></option>
                                        <option value="pt" <?php selected( $data['sb'], 'pt' ); ?>><?php esc_html_e('Post Type', 'daim'); ?></option>
                                        <option value="cl" <?php selected( $data['sb'], 'cl' ); ?>><?php esc_html_e('Content Length', 'daim'); ?></option>
                                        <option value="mi" <?php selected( $data['sb'], 'mi' ); ?>><?php esc_html_e('Manual Interlinks', 'daim'); ?></option>
                                        <option value="ai" <?php selected( $data['sb'], 'ai' ); ?>><?php esc_html_e('Auto Interlinks', 'daim'); ?></option>
                                        <option value="ii" <?php selected( $data['sb'], 'ii' ); ?>><?php esc_html_e('Internal Inbound Links', 'daim'); ?></option>
                                        <option value="op" <?php selected( $data['sb'], 'op' ); ?>><?php esc_html_e('Optimization', 'daim'); ?></option>
                                    </select>
                                </p>
