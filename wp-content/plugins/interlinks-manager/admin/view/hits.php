<?php
        ...
        //Actions
        $data['reset_hits'] = isset($_POST['reset_hits']) ? intval($_POST['reset_hits'], 10) : null;
        ...
        if(!is_null($data['reset_hits'])){
            ...
            if($result !== false){
                $process_data_message = '<div class="updated settings-error notice is-dismissible below-h2"><p>' . esc_html__('Data succesfully deleted.', 'daim') . '</p></div>';
            }
        }
        ...
        <div class="wrap">
            ...
            <div id="daext-header-wrapper" class="daext-clearfix">
                ...
                <h2><?php esc_html_e('Interlinks Manager - Hits', 'daim'); ?></h2>
                ...
                <div class="hits-container">
                        ...
                        <div class="daext-items-container">
                            ...
                            <table class="daext-items">
                                <thead>
                                    <tr>
                                        <th>
                                            <div><?php esc_html_e('Tracking ID', 'daim'); ?></div>
                                        ...
                                        <th>
                                            <div><?php esc_html_e('Type', 'daim'); ?></div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                if(get_post_status($result['source_post_id']) === false){
                                                    ...
                                                    echo '<a href="' . get_permalink($result['source_post_id']) . '">' . esc_html(apply_filters('the_title', $result['post_title'], $result['source_post_id'])) . '</a>';
                                                }
                                                ?>
                                            </td>
                    ...
                    <?php else : ?>
                        ...
                        if(strlen(trim($filter)) > 0){
	                        ...
	                        echo '<div class="error settings-error notice is-dismissible below-h2"><p>' . esc_html__('There are no hits at the moment.',
			                        'daim') . '</p></div>';
                        }
                ...
                <div class="sidebar-container">
                    ...
                    <div class="daext-widget">
                        ...
                        <h3 class="daext-widget-title"><?php esc_html_e('Reset Hits', 'daim'); ?></h3>

                        <div class="daext-widget-content">
                            
                            <p><?php esc_html_e('This procedure allows you to reset the hits.', 'daim'); ?></p>
