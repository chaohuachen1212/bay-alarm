<?php
        ...
        <div class="wrap">
            ...
            <div id="daext-header-wrapper" class="daext-clearfix">
                ...
                <h2><?php esc_html_e('Interlinks Manager - Juice', 'daim'); ?></h2>
            ...
            <div id="daext-menu-wrapper" class="daext-clearfix">
                ...
                <div class="juice-container">
                    ...
                    <?php else : ?>        
                        ...
                        if(strlen(trim($filter)) > 0){
	                        ...
	                        echo '<div class="error settings-error notice is-dismissible below-h2"><p>' . esc_html__('There are no data at moment, click on the "Generate Data" button to generate data about the flow of "Link Juice" on the URLs of your website.',
			                        'daim') . '</p></div>';
                        }
                ...
                <div class="sidebar-container">
                    ...
                    <div class="daext-widget">
                        ...
                        <h3 class="daext-widget-title"><?php esc_html_e('Juice Data', 'daim'); ?></h3>

                        <div class="daext-widget-content">
                            
                            <p><?php esc_html_e('This procedure allows you to generate data about the flow of "Link Juice" on the URLs of your website.', 'daim'); ?></p>
