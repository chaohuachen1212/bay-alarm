    ...
    <div class="tenweb-cache-wrap">
        <div class="tenweb-cache-row">
            <div class="tenweb-cache-text">
                ...
                <div class="tenweb-wrap-text-desc">
                    <span>We use NGINX FastCGI Static Page Caching to cache everything from
                    pages to feeds to 301-redirects on sub-domains.<br class="line-break"/> It helps your site to load
                        super fast for your non-logged-in visitors.</span>

                    <div class="tenweb-cache-buttons">
                        <a href="<?php echo $tenweb_hosting_tools_page ?>" target="_blank" class="tenweb-cache-manage-button">manage
                            cache</a>
        ...
        <div id="tenweb-exclude-page-cache-row" class="tenweb-cache-row loading">
            ...
            <div class="tenweb_cache_exclude__input">
                <input name="tenweb_cache_exclude" placeholder="Enter the path" type="text" class="tenweb-input" id="tenweb_cache_exclude_input">
