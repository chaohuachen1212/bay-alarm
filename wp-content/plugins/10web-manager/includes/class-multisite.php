...
namespace Tenweb_Manager {
    ...
    class Multisite
    {
        ...
        public function blog_activated($blog_id)
        {
            ...
            update_blog_option($blog_id, TENWEB_PREFIX . '_domain_id', $response_data["new_domain_id"]);
            update_blog_option($blog_id, TENWEB_PREFIX . '_is_available', $response_data["is_available"]);
