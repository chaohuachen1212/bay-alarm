...
namespace Tenweb_Manager {
  include_once TENWEB_INCLUDES_DIR . "/pear/PEAR_ErrorStack.php";
  include_once TENWEB_INCLUDES_DIR . "/pear/PEAR_Exception.php";
  ...
  class PEAR
  {
     ...
     * @access  private
     */
    var $_error_class = 'PEAR_Exception';
     ...
     *                            error objects, defaults to PEAR_Exception.
     *
     * @access public
     * @return void
     */
                                          ...
                                          $skipmsg = false)
    {
      ...
      if ($error_class !== null) {
        $ec = $error_class;
      } else if ($object !== null && isset($object->_error_class)) {
