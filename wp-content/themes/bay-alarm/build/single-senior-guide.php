<?php
  ...
  update_option('current_page_template','single single-guide'); // <----- this adds a body class
  get_header();
  $post_exclude_ids = [25578, 25848, 26446];
?>
 ...
 <section class="blog-detail--hero">
    <div class="container">
      <div class="row">
      <article>
        <span class="eyebrows">Senior Resource Guide</span>
