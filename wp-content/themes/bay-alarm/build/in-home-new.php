<?php
  // Template Name: In-Home New
  update_option('current_page_template','product-details-page prod-inhome-new');
  get_header();
...
<section class="prod-new--hero">
  ...
  <div class="container">
    <div class="text-wrap">
      ...
      <?php if (get_field('hero_video_url')): ?>
      <article class="video-box video-modal-call" data-videosrc="<?php the_field('hero_video_url') ?>" tabindex="0" role="button">
        <div class="flex">
      ...
      <?php if (get_field('hero_share_text')): ?>
      <div class="social-wrap">
        <p class="share-text"><?php the_field('hero_share_text') ?></p>
        <div class="social-icons">
          <?php
          	if( have_rows('hero_social_icons') ):
          	while( have_rows('hero_social_icons') ): the_row();
          ?>
          <a href="<?php the_sub_field('link') ?>" target="_blank">
            <img src="<?php the_sub_field('icon') ?>" alt="Soical Icon">
          </a>
          <?php
          	endwhile; endif;
          ?>
      ...
      <?php if (!empty(get_field('hero_logos_list'))): ?>
      <div class="logo-wrap">
        <?php
...
========================================================= -->
<?php if (get_field('communication_on_of_off')==='on'): ?>
<section class="prod-new--commu">
  <div class="container">
    <article class="prod-new-text-box center">
      <h2><?php the_field('communication_title') ?></h2>
      <p><?php the_field('communication_copy') ?></p>
    </article>

    <article class="prod-img-wrap">
      <img src="<?php the_field('communication_image') ?>" alt="in-home device">
    ...
    <article class="cols-wrap">
      <?php
        if( have_rows('communication_cards') ):
        while( have_rows('communication_cards') ): the_row();
      ?>
      <div class="col">
        <?php if (get_sub_field('icon')['url']): ?>
        <div class="icon">
    ...
    <a href="<?php the_field('communication_button_url') ?>" class="blue btn-outline"><?php the_field('communication_button_copy') ?></a>
    ...
    <div class="container">
      <article class="prod-new-text-box">
        <div class="l-col">
          ...
          <?php if (get_field('column_turn_on_video_youtube')==='on'): ?>
            <figure class="video-img video-modal-call" style="background-image: url(<?php the_field('column_image') ?>);" data-videosrc="<?php the_field('youtube_video_url') ?>">
              <span class="icon"><?php include 'inc/vectors/play-button.svg' ?></span>
            </figure>
          <?php else: ?>
            <img src="<?php the_field('column_image') ?>" alt="Image">
          <?php endif; ?>
...
<?php if (get_field('help_button_title')): ?>
<!-- =========================================================
...
<?php if (get_field('turn_on_wall_section')): ?>
...
<?php if (get_field('turn_on_specifications_section')==='on'): ?>
