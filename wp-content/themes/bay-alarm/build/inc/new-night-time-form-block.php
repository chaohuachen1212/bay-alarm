 <section class="free-quote--hero new-style-night-form--hero <?php if(get_field('day_time_form_showing_on_the_top')): echo 'day-time-form-top'; endif; ?>">
      <div class="container">
        <div class="row hero-row">
          <div class="col-l">
            <article>
              <?php if (get_field('day_time_form_subhead_image')): ?>
                <?php if (get_field('day_time_form_subhead_link')): ?>
                  <a href="<?php the_field('day_time_form_subhead_link') ?>" >
